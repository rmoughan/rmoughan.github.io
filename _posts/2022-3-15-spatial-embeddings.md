...
![](/assets/spatial-embeddings-for-model-based-rl/grid-env.png)
...
![](/assets/spatial-embeddings-for-model-based-rl/grid-env-teleporter.png)
...
![](/assets/spatial-embeddings-for-model-based-rl/manifold-two-way-teleporter-annotated.png)
...
![](/assets/spatial-embeddings-for-model-based-rl/manifold-one-way-teleporter.png)
...
![](/assets/spatial-embeddings-for-model-based-rl/four-room-env.png)
...
![](/assets/spatial-embeddings-for-model-based-rl/four-room-manifold-2d.png)
![](/assets/spatial-embeddings-for-model-based-rl/four-room-manifold-3d.png)
